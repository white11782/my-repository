...
int main(int argc, char** argv)
{
	...
	Mat hsv_half_down;
	src_base = imread("E:\\研究生资料\\老婆\\相册\\145kb.jpg");
	src_test1 = imread("E:\\研究生资料\\老婆\\相册\\145kb.jpg");
	src_test2 = imread("E:\\研究生资料\\老婆\\相册\\145kb.jpg");
	imshow("HistComSource0", src_base);
	imshow("HistComSource1", src_test1);
	imshow("HistComSource2", src_test2);
	waitKey(0);
	...
	normalize(hist_half_down, hist_half_down, 0, 1,
		NORM_MINMAX, -1, Mat());
	calcHist(&hsv_test1, 1, channels, Mat(),
		hist_test1, 2, histSize, ranges, true, false);
	normalize(hist_test1, hist_test1, 0, 1,
		NORM_MINMAX, -1, Mat());
	calcHist(&hist_test2, 1, channels, Mat(),
